...
class Jokes(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        elif "pythonic" in str(message.content).lower():
        ...
        elif str(message.content).lower() == "literally 1984":
            randomValue = random.randint(1, 10)
            if randomValue >= 9:
        ...
        elif str(message.content).lower() == "nya":
            randomValue = random.randint(1, 10)
            if randomValue == 10:
        ...
        elif str(message.content).lower() == "meow":
            randomValue = random.randint(1, 10)
            if randomValue == 10:
