        ...
        if action == "help":
            ...
            match selected_dropdown:
                ...
                case "purge":
                    ...
                    await message.edit(
                        embed=SersiHelp.purge_dropdown_embed(
                            interaction, kwargs["preferred_view"]
                        ),
                        view=HelpView(
                            selected_type="moderation",
                ...
                case "reformation":
                    ...
                    await message.edit(
                        embed=SersiHelp.reformation_dropdown_embed(
                            interaction, kwargs["preferred_view"]
                        ),
                        view=HelpView(
                            selected_type="moderation",
                ...
                case "slur_detection":
                    ...
                    await message.edit(
                        embed=SersiHelp.slur_detection_dropdown_embed(
                            interaction, kwargs["preferred_view"]
                        ),
                        view=HelpView(
                            selected_type="moderation",
                ...
                case "timeout":
                    ...
                    await message.edit(
                        embed=SersiHelp.timeout_dropdown_embed(
                            interaction, kwargs["preferred_view"]
                        ),
                        view=HelpView(
                            selected_type="moderation",
                ...
                case "warning":
                    ...
                    await message.edit(
                        embed=SersiHelp.warn_dropdown_embed(
                            interaction, kwargs["preferred_view"]
                        ),
                        view=HelpView(
                            selected_type="moderation",
                ...
                case "whois":
                    ...
                    await message.edit(
                        embed=SersiHelp.whois_dropdown_embed(
                            interaction, kwargs["preferred_view"]
                        ),
                        view=HelpView(
                            selected_type="moderation",
