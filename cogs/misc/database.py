...
class Database(commands.Cog):
    ...
    async def offence_fill(self, interaction: nextcord.Interaction):
        ...
        cursor.execute(
            """INSERT INTO offences (offence, first_instance, second_instance, third_instance, description) VALUES
            ...
            ('Tier 1 NSFL', 'Warning', 'Warning', 'Warning', 'This is mild gore or violence that isn't too disturbing. This can be posted with a spoiler tag and appropriate warnings.'),
