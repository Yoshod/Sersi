    ...
    async def callback(self, interaction):
        ...
        match (interaction.channel.name[:-5]):  # Removes last four digits and dash leaving just the ticket type
            case "admin-ticket":
                ...
                await ticketutils.ticket_close(self.config, interaction, complainer, "admin_ticket")
            ...
            case "senior-ticket":
                ...
                await output_channel.send(embed=close_embed)
                await ticketutils.ticket_close(self.config, interaction, complainer, "senior_ticket")
                await interaction.channel.delete(reason="Ticket closed")
            ...
            case "mod-ticket":
                ...
                await output_channel.send(embed=close_embed)
                await ticketutils.ticket_close(self.config, interaction, complainer, "mod_ticket")
                await interaction.channel.delete(reason="Ticket closed")
            ...
            case "verification-ticket":
                ...
                await output_channel.send(embed=close_embed)
                await ticketutils.ticket_close(self.config, interaction, complainer, "verification_ticket")
                await interaction.channel.delete(reason="Ticket closed")
