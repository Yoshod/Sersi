...
class SersiHelpEmbeds:
    ...
    def adult_dropdown_embed(interaction: nextcord.Interaction, preferred_view: str):
        if preferred_view == "desktop":
            return SersiEmbed(
                ...
                f"{CONFIG.emotes.blank}**Required Role**: {interaction.guild.get_role(CONFIG.roles.staff.admin).mention}\n"
                ...
                f"{CONFIG.emotes.blank}**Required Role**: {interaction.guild.get_role(CONFIG.roles.staff.mod_lead).mention}\n"
                f"{CONFIG.emotes.blank}**Required Arguments**:\n"
                ...
                f"{CONFIG.emotes.blank}**Required Role**: {interaction.guild.get_role(CONFIG.roles.staff.mod).mention}\n"
                f"{CONFIG.emotes.blank}**Required Arguments**:\n"
    ...
    def suggestion_dropdown_embed(
        ...
        if preferred_view == "desktop":
            return SersiEmbed(
                ...
                f"{CONFIG.emotes.blank}**Required Role**: {interaction.guild.get_role(CONFIG.roles.staff.cet).mention}\n"
                f"{CONFIG.emotes.blank}**Required Arguments**:\n"
    ...
    def voice_dropdown_embed(interaction: nextcord.Interaction, preferred_view: str):
        if preferred_view == "desktop":
            ...
            return SersiEmbed(
                title="Sersi Help Menu - Community Commands",
                description=f"</mass_move:1172948462652903454>\n"
                f"{CONFIG.emotes.blank}**Required Role**: {interaction.guild.get_role(CONFIG.roles.staff.base).mention}\n"
                f"{CONFIG.emotes.blank}**Required Arguments**:\n"
    ...
    def archive_dropdown_embed(interaction: nextcord.Interaction, preferred_view: str):
        if preferred_view == "desktop":
            ...
            return SersiEmbed(
                title="Sersi Help Menu - Archive Commands",
                description=f"</archive:1166849338404778056>\n"
                f"{CONFIG.emotes.blank}**Required Role**: {CONFIG.roles.staff.admin}\n"
                f"{CONFIG.emotes.blank}**Required Arguments**:\n"
    ...
    def compliance_dropdown_embed(
        ...
        if preferred_view == "desktop":
            return SersiEmbed(
                ...
                f"{CONFIG.emotes.blank}**Required Role**: {interaction.guild.get_role(CONFIG.roles.staff.compliance).mention}\n"
                f"{CONFIG.emotes.blank}**Required Arguments**:\n"
    ...
    @staticmethod
    def warn_dropdown_embed(interaction: nextcord.Interaction, preferred_view: str):
        if preferred_view == "desktop":
            return SersiEmbed(
                title="Sersi Help Menu - Warn Commands",
                description=f"</warn add:1169383880961314827>\n"
                f"{CONFIG.emotes.blank}**Required Role**: {interaction.guild.get_role(CONFIG.roles.staff.mod).mention}\n"
                f"{CONFIG.emotes.blank}**Required Arguments**:\n"
                f"{CONFIG.emotes.blank}{CONFIG.emotes.blank}`offender: The member to warn.`\n"
                f"{CONFIG.emotes.blank}{CONFIG.emotes.blank}`offence: The offence for the warning.`\n"
                f"{CONFIG.emotes.blank}{CONFIG.emotes.blank}`detail: The details for the warning.`\n"
                f"{CONFIG.emotes.blank}**Optional Arguments**:\n"
                f"{CONFIG.emotes.blank}{CONFIG.emotes.blank}`None`\n"
                f"{CONFIG.emotes.blank}**Description**:\n"
                f"{CONFIG.emotes.blank}{CONFIG.emotes.blank}`Warn a user.`\n\n"
                f"</warn deactivate:1169383880961314827>\n"
                f"{CONFIG.emotes.blank}**Required Role**: {interaction.guild.get_role(CONFIG.roles.staff.mod).mention}\n"
                f"{CONFIG.emotes.blank}**Required Arguments**:\n"
                f"{CONFIG.emotes.blank}{CONFIG.emotes.blank}`case_id: The case ID of the warning to deactivate.`\n"
                f"{CONFIG.emotes.blank}{CONFIG.emotes.blank}`reason: The reason for the deactivation.`\n"
                f"{CONFIG.emotes.blank}**Optional Arguments**:\n"
                f"{CONFIG.emotes.blank}{CONFIG.emotes.blank}`None`\n"
                f"{CONFIG.emotes.blank}**Description**:\n"
                f"{CONFIG.emotes.blank}{CONFIG.emotes.blank}`Deactivate a warning.`\n\n"
                f"</warn delete:1169383880961314827>\n"
                f"{CONFIG.emotes.blank}**Required Role**: {interaction.guild.get_role(CONFIG.roles.staff.admin).mention}\n"
                f"{CONFIG.emotes.blank}**Required Arguments**:\n"
                f"{CONFIG.emotes.blank}{CONFIG.emotes.blank}`case_id: The case ID of the warning to delete.`\n"
                f"{CONFIG.emotes.blank}{CONFIG.emotes.blank}`reason: The reason for the deletion.`\n"
                f"{CONFIG.emotes.blank}**Optional Arguments**:\n"
                f"{CONFIG.emotes.blank}{CONFIG.emotes.blank}`None`\n"
                f"{CONFIG.emotes.blank}**Description**:\n"
                f"{CONFIG.emotes.blank}{CONFIG.emotes.blank}`Delete a warning.`",
            ).set_footer(text="Sersi Help")
